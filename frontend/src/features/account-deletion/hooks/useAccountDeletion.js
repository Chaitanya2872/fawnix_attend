...
var accountDeletion_service_1 = require("../services/accountDeletion.service");
function useAccountDeletion() {
    var _this = this;
    var _a = (0, react_1.useState)(''), empCode = _a[0], setEmpCode = _a[1];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    _a = setStatus;
                    return [4 /*yield*/, (0, accountDeletion_service_1.sendAccountDeletionOtp)(empCode.trim())];
                case 2:
                    _a.apply(void 0, [_b.sent()]);
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _b.sent();
                    setStatus(error_1 instanceof Error ? error_1.message : 'Unable to reach server. Please try again later.');
                    return [3 /*break*/, 5];
                case 4:
                    setIsLoading(false);
                    return [7 /*endfinally*/];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, 4, 5]);
                    _a = setStatus;
                    return [4 /*yield*/, (0, accountDeletion_service_1.deleteAccountWithOtp)(empCode.trim(), otp.trim())];
                case 2:
                    _a.apply(void 0, [_b.sent()]);
                    return [3 /*break*/, 5];
                case 3:
                    error_2 = _b.sent();
                    setStatus(error_2 instanceof Error ? error_2.message : 'Unable to reach server. Please try again later.');
                    return [3 /*break*/, 5];
                case 4:
                    setIsLoading(false);
                    return [7 /*endfinally*/];
