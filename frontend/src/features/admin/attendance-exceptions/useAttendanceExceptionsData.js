...
exports.useAttendanceExceptionsData = useAttendanceExceptionsData;
 ...
 */
function useAttendanceExceptionsData(_a) {
    var _this = this;
    ...
    var buildUrl = (0, react_1.useCallback)(function (activeFilters, activePage) {
        ...
        if (activeFilters.exceptionType)
            params.set('type', activeFilters.exceptionType);
        ...
        return "/api/admin/attendance-exceptions?".concat(params.toString());
    }, []);
    var fetchData = (0, react_1.useCallback)(function (activeFilters, activePage, token) { return __awaiter(_this, void 0, void 0, function () {
        var url, response, data, records, paginationData, kpiData, err_1;
            ...
            switch (_j.label) {
                ...
                case 2:
                    ...
                    if (!(response === null || response === void 0 ? void 0 : response.success)) {
                        throw new Error((response === null || response === void 0 ? void 0 : response.message) || 'Failed to load attendance exceptions');
                    }
                    ...
                    setRows(records);
                    setKpis(__assign(__assign(__assign({}, EMPTY_KPIS), kpiData), { daily_trend: Array.isArray(kpiData.daily_trend) ? kpiData.daily_trend : [], repeat_offenders: __assign(__assign({}, EMPTY_KPIS.repeat_offenders), ((_d = kpiData.repeat_offenders) !== null && _d !== void 0 ? _d : {})), top_short_hours: Array.isArray(kpiData.top_short_hours) ? kpiData.top_short_hours : [] }));
                    setFilterOptions(__assign(__assign(__assign({}, EMPTY_FILTER_OPTIONS), ((_e = data.filter_options) !== null && _e !== void 0 ? _e : {})), { departments: Array.isArray((_f = data.filter_options) === null || _f === void 0 ? void 0 : _f.departments)
                            ? data.filter_options.departments
                            : [] }));
                    setPagination(__assign(__assign(__assign({}, EMPTY_PAGINATION), paginationData), { total_records: (_h = (_g = paginationData.total_records) !== null && _g !== void 0 ? _g : paginationData.total) !== null && _h !== void 0 ? _h : records.length }));
                    setLastSyncedAt(new Date());
                    return [3 /*break*/, 5];
                case 3:
                    err_1 = _j.sent();
                    setError(err_1 instanceof Error ? err_1.message : 'Failed to load attendance exceptions');
                    setRows([]);
                    setKpis(EMPTY_KPIS);
                    return [3 /*break*/, 5];
                case 4:
