...
exports.employeeMasterResources = exports.employeeMasterResourceConfigs = exports.EMPLOYEE_MASTER_STATUS_OPTIONS = void 0;
exports.getEmployeeMasterResourceByPanel = getEmployeeMasterResourceByPanel;
exports.isEmployeeMasterSidebarId = isEmployeeMasterSidebarId;
exports.EMPLOYEE_MASTER_STATUS_OPTIONS = [
...
var statusField = {
    ...
    required: true,
    type: 'select',
    options: exports.EMPLOYEE_MASTER_STATUS_OPTIONS,
};
...
exports.employeeMasterResourceConfigs = {
    workingUnits: {
        key: 'workingUnits',
...
exports.employeeMasterResources = Object.values(exports.employeeMasterResourceConfigs);
function getEmployeeMasterResourceByPanel(panel) {
    return exports.employeeMasterResources.find(function (resource) { return resource.sidebarId === panel; }) || null;
}
function isEmployeeMasterSidebarId(panel) {
    return exports.employeeMasterResources.some(function (resource) { return resource.sidebarId === panel; });
}
