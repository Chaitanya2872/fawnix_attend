...
function FawnixApp() {
    ...
    var renderDashboardPanel = function () {
        ...
        if (employeeMasterIsActive) {
            return (<AdminEmployeeMasterPage_1.default key={employeeMasterResource.key} accessToken={accessToken} actionLoading={employeeMasterActionLoading} actionStatus={employeeMasterActionStatus} apiRequest={apiRequest} canWriteAdminData={canWriteAdminData} employees={employees} error={employeeMasterError} filterOptions={employeeMasterFilterOptions} filters={employeeMasterFilters} appliedFilters={employeeMasterAppliedFilters} lastSyncedAt={employeeMasterLastSyncedAt} loading={employeeMasterLoading} pagination={employeeMasterPagination} records={employeeMasterRecords} resource={employeeMasterResource} resources={employeeMasterConfig_1.employeeMasterResources} onSelectResource={function (sidebarId) {
