...
exports.tourDayLoop = exports.tourOutcomes = exports.tourCapabilities = exports.tourMetrics = exports.tourChapters = void 0;
exports.tourChapters = [
    {
        id: "command",
        number: "01",
    ...
    },
    {
        ...
        highlights: [
            ...
            },
            {
                ...
                detail: "Out-of-range movement flags itself before it becomes a dispute.",
            },
            {
                term: "Visit evidence",
...
exports.tourOutcomes = [
    {
        role: "Field operations",
        team: "Distributed service teams",
        quote: "Visits, travel and attendance arrive as one verified timeline, so a day in the field is as legible as a day at a desk.",
        metric: "Route-level",
    ...
    },
    {
        ...
        quote: "Shift compliance, break discipline and daily closure stop depending on whoever remembered to send the message.",
        metric: "Same-day",
    ...
    },
    {
        ...
        team: "Revenue teams",
        quote: "Activities tie back to leads with a verified visit history, so pipeline conversations start from facts.",
        metric: "Lead-linked",
    ...
    },
    {
        ...
        quote: "Approvals, exceptions and audit history live in one place, which makes month-end a review instead of an investigation.",
        metric: "One trail",
